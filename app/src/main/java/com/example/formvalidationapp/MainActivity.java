...
public class MainActivity extends AppCompatActivity
{
    ...
    private EditText surnameInputForm;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        surnameInputForm = findViewById(R.id.surnameForm);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String surname = surnameInputForm.getText().toString().trim();
                ...
                if(surname.isEmpty()) { Toast.makeText(MainActivity.this,  "Wprowadź nazwisko", Toast.LENGTH_SHORT).show();  return; }
